...
def main():
    ...
    with recorded_run(ROOT,'notebook-validation',notebooks,{'cell_timeout_seconds':300}) as out:
        completed=[]
        for path in notebooks:
            ...
            write_json(out/'summary.json',{'completed':completed,'count':len(completed)})
