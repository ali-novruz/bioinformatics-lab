...
if __name__=='__main__':
    ...
    out=new_run(root,'custom-rnaseq',parameters={'design':a.design,'counts':str(Path(a.counts).resolve()),'metadata':str(Path(a.metadata).resolve())})
    import hashlib
    ...
    plot_expression(res,norm,meta,out);print(out)
