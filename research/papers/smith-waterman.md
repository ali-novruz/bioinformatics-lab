...
**Authors:** Smith & Waterman

**Year:** 1981

**Primary source:** [https://doi.org/10.1016/0022-2836(81)90087-5](https://doi.org/10.1016/0022-2836(81)90087-5)
**Reading status:** method, principal evidence and limitations reviewed; no full-paper reproduction claimed.

## Question and method

The paper asks how to obtain an optimal local alignment under the chosen scores. Its central method is **local dynamic programming with zero reset**. Input unit, objective function, validation dataset and comparison baseline must be read together; the tool name alone does not define an analysis.
...
quadratic cost and no database-scale statistical calibration. Any local result must therefore report data origin, split/unit, parameter version, uncertainty and the claim boundary.
