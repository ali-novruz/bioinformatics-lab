...
**Primary source:** [https://doi.org/10.1038/s41587-019-0209-9](https://doi.org/10.1038/s41587-019-0209-9)
**Reading status:** method, principal evidence and limitations reviewed; no full-paper reproduction claimed.

## Question and method

The paper asks how to obtain auditable amplicon/microbiome analysis. Its central method is **provenance-tracked plugin workflows**. Input unit, objective function, validation dataset and comparison baseline must be read together; the tool name alone does not define an analysis.
...
provenance does not repair biased sampling, contaminants or compositional inference. Any local result must therefore report data origin, split/unit, parameter version, uncertainty and the claim boundary.
