...
**Primary source:** [https://doi.org/10.1186/gb-2014-15-2-r29](https://doi.org/10.1186/gb-2014-15-2-r29)
**Reading status:** method, principal evidence and limitations reviewed; no full-paper reproduction claimed.

## Question and method

The paper asks how to obtain linear-model analysis of transformed RNA-seq counts. Its central method is **mean-variance trend and precision-weighted linear models**. Input unit, objective function, validation dataset and comparison baseline must be read together; the tool name alone does not define an analysis.
...
low counts and trend estimation require diagnostics. Any local result must therefore report data origin, split/unit, parameter version, uncertainty and the claim boundary.

## Repository connection

See [`docs/statistics/README.md`](../../docs/statistics/README.md). A useful exercise is to identify which paper assumptions are satisfied there, which are only approximated, and one control that would falsify the local interpretation.
