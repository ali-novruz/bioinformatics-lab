...
**Primary source:** [https://doi.org/10.1186/s13059-017-1382-0](https://doi.org/10.1186/s13059-017-1382-0)
**Reading status:** method, principal evidence and limitations reviewed; no full-paper reproduction claimed.

## Question and method

The paper asks how to obtain scalable AnnData-centred workflows. Its central method is **Python single-cell preprocessing and graph analysis**. Input unit, objective function, validation dataset and comparison baseline must be read together; the tool name alone does not define an analysis.
...
default pipelines do not solve donor replication, batch or annotation validity. Any local result must therefore report data origin, split/unit, parameter version, uncertainty and the claim boundary.
