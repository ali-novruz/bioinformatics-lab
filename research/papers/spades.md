...
**Authors:** Bankevich et al.

**Year:** 2012

**Primary source:** [https://doi.org/10.1089/cmb.2012.0021](https://doi.org/10.1089/cmb.2012.0021)
**Reading status:** method, principal evidence and limitations reviewed; no full-paper reproduction claimed.

## Question and method

The paper asks how to obtain short-read microbial assembly. Its central method is **multi-k de Bruijn graph assembly**. Input unit, objective function, validation dataset and comparison baseline must be read together; the tool name alone does not define an analysis.
...
repeat resolution and contamination depend on coverage and library assumptions. Any local result must therefore report data origin, split/unit, parameter version, uncertainty and the claim boundary.
